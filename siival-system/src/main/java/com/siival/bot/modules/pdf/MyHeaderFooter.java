...
public class MyHeaderFooter extends PdfPageEventHelper {
    public MyHeaderFooter(String pageTitle){
        this.pageTitle = pageTitle;
    }
    // 总页数
    PdfTemplate totalPage;
    Font hfFont = new Font( PdfFont.bfChinese, 8, Font.NORMAL);;
    ...
    public void onEndPage(PdfWriter writer, Document document) {
        ...
        try {
            ...
            table.addCell(new Paragraph(pageTitle, hfFont));// 可以直接使用addCell(str)，不过不能指定字体，中文无法显示
    ...
    public void onCloseDocument(PdfWriter writer,Document document) {
        ...
        ColumnText.showTextAligned(totalPage, Element.ALIGN_LEFT, new Paragraph(text,hfFont), 0, 6, 0);
    }
