...
public interface ExamInfoService {
    ...
    */
    Map<String,Object> queryAll(ExamInfoQueryCriteria criteria, Pageable pageable);
    ...
    */
    List<ExamInfoDto> queryAll(ExamInfoQueryCriteria criteria);
     ...
     * @return ExamInfoDto
     */
    ExamInfoDto findById(Integer id);
    ...
    * @return ExamInfoDto
    */
    ExamInfoDto create(ExamInfo resources);

    /**
    * 编辑
    * @param resources /
    */
    void update(ExamInfo resources);
    ...
    * @throws IOException /
    */
    void download(List<ExamInfoDto> all, HttpServletResponse response) throws IOException;

    PageResult<ExamInfoVo> findExamInfoVoByKeywords(SearchExamReq req);

    Integer exportExamInfo(ExportInfoReq req, Integer needIntegral);

    void handlerExportExam();

    ExamExportInfo findExamExportInfo(Integer uid);
}