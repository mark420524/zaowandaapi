...
import com.siival.bot.domain.EmailConfig;
import com.siival.bot.domain.vo.EmailVo;
import com.siival.bot.repository.EmailRepository;
...
import com.siival.bot.utils.EncryptUtils;
...
public class EmailServiceImpl implements EmailService {
    ...
    public void send(EmailVo emailVo, EmailConfig emailConfig){
        ...
        DataSource fileSource = buildFileDataSource(emailVo.getFileName());
    ...
    private DataSource buildFileDataSource(String fileName) {
